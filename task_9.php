    ...
    <body class="mod-bg-1 mod-nav-link ">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <form action="task_9.php" method="post">
                                        ...
                                        <button class="btn btn-success mt-3" type="submit" name="form_submit" value="submit">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        <?php 
            ...
            if (isset($data["form_submit"])) {
                ...
                if (empty($value)) {
                    $error += ["errorText" => "Введите значение для записи в БД"];
                }
                ...
                if (empty($error)) {
                    ...
                    echo '<script>alert("Данные успешно записаны в БД!")</script>';

                }else{

                    // alert for empty data 
                    echo '<script>alert("' . $error["errorText"] . '")</script>';
