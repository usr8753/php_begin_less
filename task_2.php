                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                                ...
                                <!-- show privacy page data in loop -->
                                <?php 
                                    $PPinputDataLength = count($PPinputData) - 1;
                                    foreach ($PPinputData as $PPkey => $PPvalue){

                                        // show results
                                        echo "<h2>" . $PPvalue["privacty_title"] . "</h2>";
                                        echo "<p ".($PPkey == $PPinputDataLength ? "" : 'class="mb-g"').">" . $PPvalue["privacty_content"] . "</p>";

                                } ?>
                                <!-- end show privacy page data in loop -->
